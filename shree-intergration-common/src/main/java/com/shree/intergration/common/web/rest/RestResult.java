...
@ApiModel(value = "标准Rest返回结果")
@Data
@EqualsAndHashCode(callSuper = true)
public class RestResult<TData> extends BaseResult {

    @ApiModelProperty(value = "REST请求返回数据", dataType = "Object")
    protected TData data;

    @ApiModelProperty(value = "REST请求返回额外数据", dataType = "Object")
    ...
    public static RestResult createExceptionResult(String message, Exception ex) {
        RestResult restResult = new RestResult();
        restResult.setErrorResult(message, null, ex.getMessage());
        return restResult;
    }

    public static RestResult createExceptionResult(String message, Object data, Exception ex) {
        RestResult restResult = new RestResult();
        restResult.setErrorResult(message, data, ex.getMessage());
        return restResult;
    }
}
